...
export default function ProjectDetail() {
  // view ve setView burada hook'tan çekilmeliydi (Düzeltildi)
  const { 
  ...
  return (
    <div className="project-detail-container fade-in">
      <header className="project-detail-header">
        ...
        <div className="project-actions">
          <div className="view-switcher">
            ...
            <button className={view === "timeline" ? "active" : ""} onClick={() => setView("timeline")}>⏳ Zaman</button>
          </div>
      ...
      <main className="project-content">
        {view === "kanban" && <KanbanBoard tasks={tasks} updateTaskStatus={updateTaskStatus} />}
        ...
        {view === "timeline" && (
          <div className="timeline-view">
             <p>Zaman çizelgesi üzerinde görevleriniz sıralanıyor...</p>
             {/* Buraya Gantt Chart veya basit bir dikey timeline gelebilir */}
          </div>
        )}
      </main>
